      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2 w-full">
           <div className="bg-[#F8F9FB] p-10 md:p-14 lg:p-10 xl:p-16 rounded-[3.5rem] border border-slate-100 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-40 h-40 bg-brand/5 rounded-full -mr-20 -mt-20 blur-3xl" />
              <span className="text-brand text-[10px] font-black uppercase tracking-[0.2em] mb-8 block">
                le constat
              </span>
              <h2 className="text-3xl md:text-3xl lg:text-[1.6rem] font-extrabold text-dark mb-12 leading-[1.05]tracking-tighter ">
              ...
              <ul className="space-y-5">
                {points.map((text, idx) => (
                  <li key={idx} className="flex items-start space-x-5">
                    ...
                    <span className="text-slate-500 font-bold text-lg lg:text-base xl:text-lg leading-snug">
                      {text}
                    </span>
                  </li>
                ))}
          ...
          {/* Right: Heading & CTA */}
          <div className="lg:w-1/2 w-full">
           <h2 className="text-3xl sm:text-5xl md:text-3xl lg:text-5xl xl:text-6xl font-extrabold text-dark mb-8 md:mb-12 leading-[0.95] tracking-tighter">
              reprenez le{" "}
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-400 mb-10 md:mb-14 max-w-xl leading-relaxed font-medium">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-10">
              ...
              <div className="flex items-center space-x-4 text-slate-300">
                ...
                <span className="italic font-medium text-dark/40 uppercase tracking-widest text-[9px] font-black">
